...
var instruccion3d = /** @class */ (function () {
    ...
    instruccion3d.prototype.optimizar = function () {
        var codigo_nuevo;
        var codigoizquierda = this.ladoizquierdo.obtenercodigo();
        var codigoderecha = this.ladoderecho.obtenercodigo();
        var regla_aplicada = 0;
        var cambio = false;
        var codigo_anterior = this.objetivo + "=" + codigoizquierda.valor + this.operador + codigoderecha.valor + ";\n";
